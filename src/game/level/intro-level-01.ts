...
export class IntroLevel01 extends Phaser.Scene {
	...
	playIntro() {
		...
		this.addTextToTimeline(
			GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXT1']
		);
		this.addImageToTimeline(
			'maskedEvil',
			1500,
			+config.scale.width / 2,
			+config.scale.height / 2 - 10,
			+config.scale.width / 2,
			+config.scale.height / 2 - 10,
			true,
			5000
		...
		this.addTextToTimeline(
			GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXT2']
		);
		this.addImageToTimeline(
			'pepeThinking',
			0,
			+config.scale.width / 2 + 220,
		...
		this.addTextToTimeline(
			GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXT3']
		);
		

		this.addTextToTimeline(
			GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXT4']
		);
		this.addImageToTimeline(
			'donaldTrump',
			6200,
			+config.scale.width / 2 - 240,
		...
		this.addTextToTimeline(
			GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXT5']
		);


		var _this = this;
		this.addTextToTimeline(GAME_TRANSLATIONS[GAME_PROPERTIES.default_language]['SCENE1']['INTRO_TXTFINAL'], function() {
	        _this.gameStart();
		});
